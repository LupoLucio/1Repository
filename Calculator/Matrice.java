public class Matrice {
    ...
    public Matrice somma(Matrice matrice) {
        ...
        /*
         * if(matrice.cols != this.cols || matrice.rows!= this.rows){ throw new
         * IllegalAccessException("matrici con dimensioni diverse"); }
         */
    ...
    public Fraction[][] Scala() {
        ...
        for (int i = 0; i < rows - 1; i++) {
            for (int k = i; k < cols - 1; k++) {
                ...
                /*
                 * if(!done && i >= 1){ sottrazRighe(k+1,i-1,i,out); }
                 */
    ...
    public Matrice matInv() {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                ...
                Fraction f = new Fraction((int) Math.pow(-1, i + j), 1).prodotto(rimozioneRigaColonna(i, j).laplace());
